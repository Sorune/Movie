...
<div id="carouselExample" class="carousel slide stillcut">
	<div class="carousel-inner">
		...
		<div class="carousel-item">
			<img src="../resources/img/dune-4.jpg" class="d-block w-100 img-dark" alt="...">
		</div>
		<div class="carousel-item">
			<img src="../resources/img/dune-5.jpg" class="d-block w-100 img-dark" alt="...">
		</div>
	</div>
		...
		<div class="row g-5 align-items-center">
			<div class="col-lg-5 wow fadeInLeft" data-wow-delay="0.2s">
				<div class="about-img pb-5 ps-5">
					<img src="../resources/img/poster.jpg" class="img-fluid rounded w-100"
