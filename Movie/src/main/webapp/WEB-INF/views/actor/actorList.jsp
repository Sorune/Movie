	                ...
	                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
	                    <div class="service-item rounded">
	                       <div class="service-img rounded-top">
	                       		<c:if test="${not empty actor.imgList[0] }">
	                            	<img src='<c:out value="'/download?fileName='+${actor.imgList[0].uploadPath} + '/' + ${actor.imgList[0].uuid } + '_' + ${actor.imgList[0].fileName }'"></c:out>' class="img-fluid rounded-top w-100" alt="">
	                            </c:if>
	                       </div>
