					...
					<div class="col-lg-12">
						...
						<div class="row justify-content-center">
							...
							<form role="form" action="/director/modify/${Director.dirBno}" method="post">
								...
								<div class="row justify-content-center">
									<div class="col-4">
										<div id="uploadedImages" class="carousel slide carousel-fade"
											...
											<button class="carousel-control-prev" type="button"
												data-bs-target="#uploadedImages" data-bs-slide="prev">
												<span class="carousel-control-prev-icon" aria-hidden="true"></span>
												<span class="visually-hidden">Previous</span>
											</button>
											<button class="carousel-control-next" type="button"
												data-bs-target="#uploadedImages" data-bs-slide="next">
												<span class="carousel-control-next-icon" aria-hidden="true"></span>
												<span class="visually-hidden">Next</span>
											</button>
											<button type="button" class="carousel-control-add"
												id="uploadImage" data-bs-target="#uploadedImages">
												<span class="bi bi-file-plus fz20" aria-hidden="true"></span>
												<span class="visually-hidden">Add</span>
											</button>
											<button type="button" class="carousel-control-remove"
												id="deleteImage" data-bs-target="#uploadedImages">
												<span class="bi bi-file-x fz20" aria-hidden="true"></span> <span
													class="visually-hidden">Remove</span>
											</button>
										</div>
									</div>
									<div class="col-8">
										<div class="form-group">
											<div class="row row-cols-2 p-3">
												...
												<div class="col-sm-10">
													<input class="form-control" name='dirName' id="dirName"
														value='<c:out value="${Director.dirName}"/>'/>
												</div>
											</div>
											<div class="row row-cols-2 p-3">
												<label class="col-sm-2 text-align-center">나이</label>
												<div class="col-sm-10">
													<input class="form-control" name='dirAge' id="dirAge"
														value='<c:out value="${Director.dirAge}"/>' readonly>
												</div>
											</div>
								...
								<div class="row">
									...
									<div class="col-4">
<%-- 										<button type="button" id="removeBtn" data-oper='remove'
											class="btn btn-danger w-100"
											value="<c:out value="${Director.dirBno}"/>">삭제하기</button> --%>
									</div>
									<div class="col-4">
