						...
						<div class="form-group">
							...
							<div class="form-control " name='content'>
								<input type="checkbox" name="" value="drama">드라마 <input
									...
									type="checkbox" name="" value="drama">미국 
									<input type="checkbox" name="" value="drama">애니메이션
									<input type="checkbox" name="" value="drama">가족
									<input type="checkbox" name="" value="drama">공룡
									<input type="checkbox" name="" value="drama">코미디
									<input type="checkbox" name="" value="drama">러브 코미디
									<input type="checkbox" name="" value="drama">로멘스
									<input type="checkbox" name="" value="drama">뮤지컬
									<input type="checkbox" name="" value="drama">밀리터리
									<input type="checkbox" name="" value="drama">밀리터리SF
									<input type="checkbox" name="" value="drama">범죄물
									<input type="checkbox" name="" value="drama">생존
									<input type="checkbox" name="" value="drama">성인
									<input type="checkbox" name="" value="drama">역사물
							</div>
						</div>
						<div class="form-group">
